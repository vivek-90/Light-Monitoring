import conf_sms, json, time, math, statistics
...
sms = Sms(conf_sms.SSID, conf_sms.AUTH_TOKEN, conf_sms.TO_NUMBER, conf_sms.FROM_NUMBER)
history_data=[]
...
while True:
    ...
    bound = compute_bounds(history_data,conf_sms.FRAME_SIZE,conf_sms.MUL_FACTOR)
    if not bound:
        required_data_count=conf_sms.FRAME_SIZE-len(history_data)
